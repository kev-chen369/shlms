...
2026-09-17 合并基线说明：本工程已实现的是 V2 五栏首页、推广身份状态组件与商品链接准备页。当前产品文档以 V3 多平台四栏和「万宝单生活」为目标；相应页面及名称适配尚待单独研发验收，不能把新版设计或京东签名客户端合入视为真实业务已接通。后续范围见主研发计划 M1-01v3、M2-05b/c。
