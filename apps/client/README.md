...
2026-09-19 当前基线说明：本工程已实现的是 V2 五栏首页、推广身份状态组件与商品链接准备页，客户端显示名称已按 DOC-08 更新为「万宝单生活」。V3 多平台四栏页面仍待单独研发验收，不能把新版设计或京东签名客户端合入视为真实业务已接通。后续范围见主研发计划 M1-01v3、M2-05b/c；AppID / 包名 / 渠道媒体 ID 和历史分享文案不因展示名称更新而更改。
