...
func promotionShareEventsHandler(d Dependencies) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		result, err := d.ShareEvents.RecordShareEvent(r.Context(), conversion.ShareEventInput{OwnerUserID: userID, LinkID: r.PathValue("id"), EventID: body.EventID, Action: body.Action, Scene: body.Scene})
		if err != nil {
			switch {
