...
func TestRunActualMigrationsConcurrentlyAndRepeatedly(t *testing.T) {
	...
	for _, table := range []string{"tracking_records", "promoter_profiles", "promoter_applications", "promotion_positions", "promotion_previews", "channel_positions", "channel_position_config_events", "admin_principals", "admin_permissions"} {
		var exists bool
